...
export const toolDescriptions: Record<ToolName, string> = {
    ...
    canvas_get_state: "读取当前网页画布的结构概览：节点 id/类型/标题/位置/尺寸/状态/图片摘要、全部连线、选区和视口。不包含节点内容全文；需要看提示词或生成参数时用 canvas_get_nodes。",
    canvas_get_selection: "读取当前网页画布选中的节点（结构概览，同 canvas_get_state 节点形状）。",
