export default {
    ...
    agent: {
        connection: { title: "Local Agent connection", description: "MCP clients read and write the current canvas through the local Canvas Agent; the canvas top bar shows the connection status once connected.", url: "Local URL", token: "Connect Token", connect: "Connect", disconnect: "Disconnect" },
        status: { connected: "Connected", connecting: "Connecting", disconnected: "Disconnected" },
        state: { connectionRequired: "Enter the Local URL and Connect token", invalidUrl: "The Local URL is invalid", offline: "Offline", requestFailed: "Local Agent request failed" },
        ...
        composer: { mentions: { resourceMissing: "Canvas asset u201c{{title}}u201d no longer exists", imageReadFailed: "Could not read canvas image u201c{{title}}u201d" } },
        runtime: { agentOutdated: "The local Agent is outdated. Restart Canvas Agent and reconnect.", restartRequired: "Agent restart required", connected: "Connected", connectionLost: "Connection lost", connectionFailed: "Connection failed", connectionLostDescription: "The local Agent connection failed or was interrupted", connectionFailedDescription: "Connection failed. Check the address and token.", openCanvasFirst: "The canvas is not open. Use site_navigate to open it first.", canvasOperationFailed: "Canvas operation failed", unknownCanvasTool: "Unsupported canvas tool: {{name}}", opsReceiptHint: "Receipt returned; use canvas_get_state for the latest structure or canvas_get_nodes for node contents." },
    },
    locale: {
        zhCN: "简体中文",
        enUS: "English",
